...
public class NoteAddNewActivity extends Activity {
	...
	protected void saveNote() {
		...
		if (flag != -1) {
			...
			NoteAddNewActivity.this.finish();
	...
	protected void ConfirmCancel(){
		AlertDialog.Builder confirmCancel = new AlertDialog.Builder(NoteAddNewActivity.this);
