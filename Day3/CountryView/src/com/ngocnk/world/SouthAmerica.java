...
public class SouthAmerica extends Activity {
	...
	protected void initUI() {
		...
		try {
			String[] ListFile = mAssetManager.list("SouthAmerica");
			for (String assets : ListFile) {
					mImageInput = mAssetManager.open("SouthAmerica/" + assets + "/flag.png");
		...
		mCountryListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				Intent intent = new Intent(SouthAmerica.this, DetailActivity.class);
				Bundle bundle = new Bundle();
				bundle.putString("FolderExtra","SouthAmerica");
