...
public class Africa extends Activity {
	...
	protected void initUI() {
		...
		try {
			String[] ListFile = mAssetManager.list("Africa");
			for (String assets : ListFile) {
					mImageInput = mAssetManager.open("Africa/" + assets + "/flag.png");
		...
		mCountryListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				Intent intent = new Intent(Africa.this, DetailActivity.class);
				Bundle bundle = new Bundle();
				bundle.putString("FolderExtra","Africa");
