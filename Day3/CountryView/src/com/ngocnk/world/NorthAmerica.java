...
public class NorthAmerica extends Activity {
	...
	protected void initUI() {
		...
		try {
			String[] ListFile = mAssetManager.list("NorthAmerica");
			for (String assets : ListFile) {
					mImageInput = mAssetManager.open("NorthAmerica/" + assets + "/flag.png");
		...
		mCountryListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				Intent intent = new Intent(NorthAmerica.this, DetailActivity.class);
				Bundle bundle = new Bundle();
				bundle.putString("FolderExtra","NorthAmerica");
