...
public class Europe extends Activity {
	...
	protected void initUI() {
		...
		try {
			String[] ListFile = mAssetManager.list("Europe");
			for (String assets : ListFile) {
					mImageInput = mAssetManager.open("Europe/" + assets + "/flag.png");
		...
		mCountryListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				Intent intent = new Intent(Europe.this, DetailActivity.class);
				Bundle bundle = new Bundle();
				bundle.putString("FolderExtra","Europe");
